/* ========================================================================
   Shared sidebar for the Low-Code Campaign Platform deep-dive.
   ...
   other language (falls back to index.html if that file doesn't exist).
...
(function () {
  ...
  const SECTIONS = {
    en: [
      ...
      { key: 'talk-track',   num: '02', label: 'Talk Track',             href: 'talk-track.html' },
      { key: 'context',      num: '03', label: 'Context & Problem',      href: 'context.html' },
      { key: 'role',         num: '04', label: 'Role & Ownership',       href: 'role.html' },
      { key: 'architecture', num: '05', label: 'Architecture',           href: 'architecture.html' },
      { key: 'modules',      num: '06', label: 'Core Modules',           href: 'modules.html' },
      { key: 'decisions',    num: '07', label: 'Key Decisions',          href: 'decisions.html' },
      { key: 'challenges',   num: '08', label: 'Challenges & Solutions', href: 'challenges.html' },
      { key: 'impact',       num: '09', label: 'Impact',                 href: 'impact.html' },
    ],
    zh: [
  ...
  // From /Portfolio/interview/projects/low-code-platform/<lang>/*.html:
  //   ../../../        → /Portfolio/interview/      (materials hub)
  //   ../../../../     → /Portfolio/                 (portfolio app)
  const MATERIALS_HREF = '../../../index.html';
  const PORTFOLIO_HREF = '../../../../';

  // Same section in the other language. Fall back to index.html if the
  // other language doesn't have a page with the same file name.
